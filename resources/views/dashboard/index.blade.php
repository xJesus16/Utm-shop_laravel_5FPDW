			...
			<div class="px-40 flex flex-1 justify-center py-5">
				<div class="layout-content-container flex flex-col max-w-[1800x] flex-1">
					...
					<div class="flex flex-wrap gap-4 px-4 py-6">
						...
						<div class="flex min-w-72 flex-1 flex-col gap-2 rounded-lg border border-[#e6e1db] p-6">
							<p class="text-[#181511] text-base font-medium leading-normal">Ventas Por Productos</p>
							<div class="flex items-center">
								<select v-model="filtro_chart_5.genero" class="custom-select h-9 cursor-pointer rounded-md border border-[#e6e1db] bg-white px-3 py-1 text-xs font-semibold text-[#897961] focus:border-[#897961] focus:ring-0">
									<option value="">Todos</option>
