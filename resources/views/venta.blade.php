    ...
    <div class="layout-container flex h-full grow flex-col">
      ...
      <div id="app" class="gap-1 px-6 flex flex-1 justify-center py-5">
        <div class="layout-content-container flex flex-col max-w-[920px] flex-1">
          ...
          <div v-if="!extras" class="flex flex-wrap justify-between gap-3 p-4">
            <p class="text-[#181511] tracking-light text-[32px] font-bold leading-tight min-w-72">Realiza un pedido</p>
          </div>
        ...
        <div v-if="!extras" class="layout-content-container flex flex-col w-[360px]">
          ...
          <div v-for="(item,index) in orden" class="flex items-center gap-4 bg-white px-4 min-h-[72px] py-2 justify-between">
            ...
            <div class="shrink-0">
              <p class="text-[#181511] text-base font-normal leading-normal">$@{{item.precio}}</p>
            </div>
                ...
                <div class="flex items-center justify-between gap-3">
                  ...
                  <div class="flex items-center gap-3">
                    ...
                    <button @click="activar_extra(index)" class="flex items-center gap-2 px-3 h-9 rounded-md bg-[#f4f3f0] hover:bg-[#FFD580]" aria-label="Configurar adicionales">
                      <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 -960 960 960" fill="#5f6368">
        ...
        <button class="flex items-center gap-2 px-3 h-9 rounded-md bg-[#f4f3f0] hover:bg-[#e6e1db]" aria-label="Configurar adicionales">
          ...
          <div class="flex items-center gap-4 bg-white px-4 min-h-14 justify-between">
            ...
            <div class="shrink-0">
              <p class="text-[#181511] text-base font-normal leading-normal">$ @{{orden_summary.subtotal}}</p>
            </div>
          </div>
          <div class="flex items-center gap-4 bg-white px-4 min-h-14 justify-between">
            <p class="text-[#181511] text-base font-normal leading-normal flex-1 truncate">Tax (@{{impuesto*100}}%)</p>
            <div class="shrink-0">
              <p class="text-[#181511] text-base font-normal leading-normal">$ @{{orden_summary.impuesto}}</p>
            </div>
          </div>
          <div class="flex items-center gap-4 bg-white px-4 min-h-14 justify-between">
            <p class="text-[#181511] text-base font-normal leading-normal flex-1 truncate">Total</p>
            <div class="shrink-0">
              <p class="text-[#181511] text-base font-normal leading-normal">$ @{{orden_summary.total}}</p>
            </div>
          </div>
          ...
          <div class="flex px-4 py-3">
            <button
              ...
              <svg v-if="procesando_orden" width="30" height="30" fill="hsl(228, 97%, 42%)" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          methods: {
            ...
            guardar_orden: function() {
                ...
                if (this.orden.length === 0) {
                  Swal.fire({
                    title: ' Carrito vacío',
                    text: 'Agrega productos antes de guardar la orden',
                    icon: 'warning',
                    background: '#1f2937',
                    color: '#fff',
                    confirmButtonText: 'Agregar productos',
                    confirmButtonColor: '#0bf56d',
                    customClass: {
